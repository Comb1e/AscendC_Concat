...
CASES=(ref row_unaligned row_aligned chunk_aligned fused_tiles many_inputs single_input zero_segments preload_16 preload_17 max_inputs rank4_axis0 tile_tail chunk_imbalanced_aligned chunk_imbalanced_unaligned chunk_many_inputs chunk_single_large)
